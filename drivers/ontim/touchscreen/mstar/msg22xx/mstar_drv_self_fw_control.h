...
#ifdef CONFIG_UPDATE_FIRMWARE_BY_SW_ID
extern s32 DrvFwCtrlCheckFirmwareUpdateBySwId(void);
#endif //CONFIG_UPDATE_FIRMWARE_BY_SW_ID

extern s32  DrvFwCtrlFwForceUpdate(void) ;
extern u8 DrvFwCtrlGetChipType(void);
extern void DrvFwCtrlGetCustomerFirmwareVersion(u16 *pMajor, u16 *pMinor, u16 *pVendor);
