 ...
 * By default, this compile option is disabled.
 */
#ifdef CONFIG_ENABLE_SIMULATIONS_PROXIMITY
...
#define SLAVE_I2C_ID_DBBUS_MSG21XX         (0xC4>>1) //0x62 // for MSG21XX/MSG21XXA/MSG26XXM
#define SLAVE_I2C_ID_DBBUS_MSG22XX         (0xB2>>1) //0x59 // for MSG22XX
